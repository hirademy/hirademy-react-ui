    ...
    <div className="sidebar w-56 shadow-sm h-screen bg-white text-sky-900 flex flex-col justify-between">
      <div>
        <div className="flex items-center"> {/* Ensure items-center to align items vertically */}
          <div className=' border-2 border-sky-900 w-10 ml-4 bg-cover h-10 rounded-full '>
            <img className="bg-slate-00 rounded-full bg-cover w-10 h-9 border-slate-800" src={favicon} alt="Profile" />
          </div>
          <div className="p-3 text-2xl text-sky-900 font-bold">
            Dashboard
          </div>
        </div>
